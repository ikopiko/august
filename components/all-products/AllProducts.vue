...
<div>
    <div class="col-md-12">
        ...
        <div id="products-filter" class="products-collections-listing row">
            <ProductItem v-for="(product, index) in filteredOrders" :product="product" :key="index" @clicked="toggle" :className="`col-lg-4 col-md-6 products-col-item`"></ProductItem>
            <!-- <ProductItem v-for="(product, index) in products" :product="product" :key="index" @clicked="toggle" :className="`col-lg-4 col-md-6 products-col-item`"></ProductItem> -->
